...
<html>
	...
	<body>
		...
		WHERE convite = $getId and convidado = $id_logado and status='amigo' or convite = $getId and convidado = $id_logado and status='aguardo' or convite = $id_logado and convidado = $getId and status='amigo' or convite = $id_logado and convidado = $getId and status='aguardo'");
		...
		<div class="amigos">
			...
			$selecao = mysqli_query ($conexao,"SELECT * FROM amizade
				WHERE convite = $id and status='amigo' or convidado = $id and status='amigo'");
			?>
